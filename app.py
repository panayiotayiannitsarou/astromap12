...
Αν η υπηρεσία αφορά ενήλικα, εφάρμοσε υποχρεωτικά τον ειδικό Κανόνα 0Γ: το καθαρό παραδοτέο να είναι σύντομο, σε καθημερινή γλώσσα και χωρίς τους αναλυτικούς πίνακες, το εργασιακό περιβάλλον, τα επόμενα βήματα, το σχέδιο 8–12 εβδομάδων ή τις επαναλαμβανόμενες ενότητες της πλήρους έκδοσης. Μην αναφέρεις επαγγέλματα μέσα στην ενότητα «Ταλέντα προς διερεύνηση». Παρουσίασέ τα μόνο στους «Επαγγελματικούς Τομείς προς Διερεύνηση» και εξήγησε κάθε άγνωστο ή εξειδικευμένο επάγγελμα με μία πολύ σύντομη πρόταση. Μην προσθέσεις ενότητα για την Κύπρο, ΟΜΠ ή εκπαιδευτικές διαδρομές. Το εσωτερικό τεχνικό δελτίο παραμένει αναλυτικό.
...
Το παιδί/ο έφηβος φοιτά στο κυπριακό εκπαιδευτικό σύστημα. Στην απλή έκδοση πρόσθεσε σύντομη ενότητα «Πλαίσιο Εκπαιδευτικού Συστήματος (Κύπρος)» με τις υποενότητες «Οι τέσσερις επιλογές στην Α΄ Λυκείου», «Ποιες επιλογές αξίζει να εξετάσεις» και «Τι χρειάζεται να θυμάσαι». Παρουσίασε κάθε ΟΜΠ σε μία απλή γραμμή. Παράλειψε Παγκύπριες Εξετάσεις, Επιστημονικά Πεδία, Πλαίσια Πρόσβασης, χωριστές πανεπιστημιακές σπουδές/Τμήματα, ερωτήσεις συζήτησης, οδηγίες προς γονείς/εκπαιδευτικούς και σχέδιο 8–12 εβδομάδων. Χρησιμοποίησε μόνο πρόσφατα επαληθευμένες επίσημες πληροφορίες και μην κατατάξεις ή αποκλείσεις ΟΜΠ."""
